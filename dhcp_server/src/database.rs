 ...
 */
pub fn select_entry(con: &Connection, mac_addr: MacAddr) -> Result<Option<Ipv4Addr>> {
 ...
 */
pub fn select_addresses(con: &Connection, deleted: Option<u8>) -> Result<Vec<Ipv4Addr>> {
 ...
 */
pub fn count_records_by_mac_addr(tx: &Transaction, mac_addr: MacAddr) -> Result<u8> {
